...
`go-ruby-haml/haml` reimplements Ruby's `haml` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-haml/haml` directly, with no Ruby runtime;
