...
The public API lives at the module root (`github.com/go-ruby-haml/haml`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `haml`, while the surface follows
...
```go
import "github.com/go-ruby-haml/haml"
```
...
- **[pkg.go.dev/github.com/go-ruby-haml/haml](https://pkg.go.dev/github.com/go-ruby-haml/haml)**

The module's [README](https://github.com/go-ruby-haml/haml#readme) carries worked
